function [] = Make_Static_HeadFree_head_roll()
%% Make_Static_HeadFree_head_roll:
%   INPUTS:
%       -
%   OUTPUTS:
%       -
...
% Output file name
filename = 'Static_HeadFree_head_roll';
...
for kk = 1:N.file
    ...
    load(fullfile(PATH.head, [basename{kk} '.mat']),'yaw','roll_idx');
 	...
 	[trig,~] = sync_pattern_trigger(t_p, data(:,2), 10, data(:,1), true, round(0.5*Fs), false, false);
