function [] = Experiment_head_electro_magnet_control_ramp(Fn)
...
root = 'C:\BC\Rigid_data\Experiment_head_electro_magnet_background_ramp';
...
for ii = 1:n_rep
    ...
    pause(n_pause)
    Panel_com('send_gain_bias', [arena_gain 0 0 0])
    pause(n_pause)
