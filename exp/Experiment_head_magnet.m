function [] = Experiment_head_magnet(Fn, ctrl)
%% Experiment_head_magnet: runs a experiment using the LED arena and fly panel
% Fn is the fly number
daqreset
imaqreset
% Fn = 0;
%% Set directories & experimental parameters
root = 'C:\BC\Rigid_data\Experiment_head_magnet';
